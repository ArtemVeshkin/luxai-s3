...
def create_weights(space, coords=None, max_dist=None, energy_update_in=None):
    """
    ...
    Parameters:
        ...
        max_dist (int, optional): Maximum Manhattan distance allowed. Nodes beyond this distance are given a weight of -1.
        energy_update_in (int, optional): Distance threshold for energy update adjustments.
    ...
    for node in space:
        # Compute Manhattan distance once if reference coordinates are provided.
